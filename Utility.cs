...
namespace FovCubeMaker
{
    ...
    public class LLA // Alt is currently measured in 111.1  KM units, in order to allow all to be the same
    {
        public double lat;
        public double lon;
        public double alt;
    ...
    public class BoundingBoxECEF
    {
        public ECEF topLeft;
        public ECEF topRight;
        public ECEF botLeft;
        public ECEF botRight;

        public BoundingBoxECEF(ECEF topLeft, ECEF topRight, ECEF botLeft, ECEF botRight)
        {
